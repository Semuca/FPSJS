...
exports.toggleFullScreen = exports.FScreen = exports.SCREENACTION = void 0;
const shader_js_1 = require("./shader.js");
var SCREENACTION;
(function (SCREENACTION) {
    SCREENACTION[SCREENACTION["IDLE"] = 0] = "IDLE";
    SCREENACTION[SCREENACTION["RESIZING"] = 1] = "RESIZING";
})(SCREENACTION || (exports.SCREENACTION = SCREENACTION = {}));
// Fills up one canvas
class FScreen {
    canvas;
    gl;
    ...
    texObjects = {}; //TextureID to Texture Objects hashmap (Maybe include texture names later too)
    texIds = {}; //Texture name to TextureID hashmap
    ...
    getCamerasFromCursor(e) {
        return this.cameras.filter((camera) => (camera.tlCorner[0] * this.canvas.width - this.margin <= e.pageX && e.pageX <= camera.brCorner[0] * this.canvas.width + this.margin) &&
    ...
    AddShader(cam, vsSource, fsSource, type) {
        const shader = new shader_js_1.Shader(this, this.gl, cam, type);
    ...
    AddCamera(tlCorner, brCorner, type, worldIndex) {
        this.cameras.push(new shader_js_1.Camera(this, tlCorner, brCorner, type, worldIndex));
